...
int64 nChainStartTime = 1452561902;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 56170000 * COIN;	// 1 billion coins, that all pow coins
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in InfomationCoin
    bool fStrictPayToScriptHash = true; // Always active in InfomationCoin
...
bool CBlock::AcceptBlock()
{
    ...
    if (IsProofOfWork() && nHeight > POW_CUTOFF_BLOCK) //main.h:37
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "InfomationCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Jan 12, 2016, WenterCoin start--Putin Signs Treaty To Add Crimea To Map.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x882e672f9db160accdeb7d832dfb718c75ea8bfbb21cfc588cf6591cb7d7aae7"));
...
unsigned char pchMessageStart[4] = { 0xf5, 0xf4, 0xf9, 0x1a };
